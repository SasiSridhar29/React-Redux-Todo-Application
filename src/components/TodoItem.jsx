...
import {  FaTrash, FaCheck,FaCheckCircle, FaTimes } from 'react-icons/fa';
...
const TodoItem = ({ todo, index }) => {
  ...
  return (
    <li className="flex flex-col sm:flex-row sm:items-center justify-between border-b-2 py-2 gap-4">
      ...
      <button
          className="mr-2 text-sm  text-white sm:px-2 px-1 py-1 rounded"
          onClick={() => dispatch(toggleTodo(index))}
        >
          {todo.completed ?  <FaCheckCircle />:<FaCircleDot /> }
        </button>
